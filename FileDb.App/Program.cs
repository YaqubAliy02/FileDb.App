...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        string usee = JsonSerializer.Serialize(new User() { Id = 19, Name = "Ahmadjon" });
        File.WriteAllText(usee, @"C: \Users\ahmad\Desktop\Tarteeb 7\FileDb.App\FileDb.App\Users.json");

        jsonStorageBroker.AddUser(new User(){Id = 1,Name = "Ali"});
